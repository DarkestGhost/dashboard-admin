const Button = ({ children, variant, size, className = "", ...props }) => {
  ...
  const variants = {
    ...
    ghost: "border border-zinc-300 dark:border-zinc-600 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-800 dark:hover:text-zinc-100"
  };
