...
import { HiBars3, HiArrowRightOnRectangle, HiOutlineShoppingBag, HiOutlineListBullet, HiOutlinePlus, HiOutlineSquares2X2, HiOutlineRectangleGroup, HiOutlineArchiveBox } from "react-icons/hi2";
...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-zinc-100 dark:bg-zinc-900 transition-all duration-300 ease-linear">
      ...
      <aside className={`fixed top-0 right-0 h-full w-72 bg-zinc-800 dark:bg-zinc-900 text-zinc-100 border-l border-zinc-700 p-4 z-30 transform transition-all duration-300 ease-linear not-last-of-type: ${isSidebarOpen ? "translate-x-0" : "translate-x-full"} md:static md:translate-x-0`}>
