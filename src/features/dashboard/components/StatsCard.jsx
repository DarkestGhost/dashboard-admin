...
const StatsCard = ({ title, value, description, icon, iconColorClasses }) => {
    return (
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-md p-5 transition-all duration-300 ease-linear">
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-zinc-500 dark:text-zinc-400 font-vazir_medium transition-colors duration-300 ease-linear">
                        {title}
                    </p>
                    <h3 className="mt-4 text-zinc-800 dark:text-white text-2xl font-vazir_bold transition-colors duration-300 ease-linear">{value}</h3>
