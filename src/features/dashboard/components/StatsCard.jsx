        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-md p-5 transition-all duration-300 ease-linear">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h3 className="mt-4 text-zinc-800 dark:text-white text-2xl font-vazir_bold transition-colors duration-300 ease-linear">{formatter ? formatter(value) : value}</h3>
